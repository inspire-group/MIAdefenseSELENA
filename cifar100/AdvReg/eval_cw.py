...
def main():
    ...
    cw_attack(net, checkpoint_path, train_data_tr_attack, train_label_tr_attack, infer_train_conf_tr, train_data_te_attack, train_label_te_attack, infer_train_conf_te, ref_data, ref_label, infer_ref_conf, test_data, test_label, infer_test_conf, device, args.num_worker, num_class=num_class, batch_size=batch_size)
