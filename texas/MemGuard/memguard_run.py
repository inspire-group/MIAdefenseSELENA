...
####Loading prections and logits.
file_path = os.path.join(root_dir, 'texas',  'data', 'memguard', "prediction")
train_outputs1 = np.load(os.path.join(file_path, 'infer_train_conf_tr.npy'))
len1 = len(train_outputs1)
train_outputs2 = np.load(os.path.join(file_path, 'infer_train_conf_te.npy'))
len2 = len(train_outputs2)
train_outputs = np.concatenate((train_outputs1, train_outputs2))
test_outputs1 = np.load(os.path.join(file_path, 'infer_ref_conf.npy'))
test_outputs2 = np.load(os.path.join(file_path, 'infer_test_conf.npy'))
test_outputs = np.concatenate((test_outputs1, test_outputs2))
train_logits1 = np.load(os.path.join(file_path, 'train_logits_tr.npy'))
train_logits2 = np.load(os.path.join(file_path, 'train_logits_te.npy'))
train_logits = np.concatenate((train_logits1, train_logits2))
test_logits1 = np.load(os.path.join(file_path, 'ref_logits.npy'))
test_logits2 = np.load(os.path.join(file_path, 'test_logits.npy'))
...
defense_model = load_model(os.path.join(root_dir, 'memguard', 'texas_MIA_model.h5'))
...
np.savez(os.path.join(file_path, 'defense_results', 'texas_shadow_defense.npz'), defense_output=result_array, defense_logits = result_array_logits, 
