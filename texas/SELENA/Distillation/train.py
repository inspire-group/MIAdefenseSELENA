...
def main():
    ...
    parser.add_argument('--classifier_epochs', type=int, default=30, help='attack epochs in NN attack')
    parser.add_argument('--print_epoch', type=int, default=50, help='print nn attack accuracy stats per print_epoch during nn training')
    ...
    net1 = TexasClassifier().to(device, torch.float)
